...
if __name__ == "__main__":
    log_data = read_logs(LOG_FILE_PATH)
    ...
    print("Average Run Times:", average_run_times)
    print("Failure Counts:", failure_counts)
    print(f"Application with the most failures (ERROR): {app_most_failures}: {max_failures}")
    print(f"Application with the most successful runs (INFO): {app_most_success}: {max_successes}")
    print(f"Time interval with the most failed runs: {most_failures_period} ({period_failure_count})")
